...
- **Аноним**  
Может просматривать описания произведений, отзывы и комментарии.

- **Аутентифицированный пользователь (`user`)**  
Может всё, что и Аноним, плюс:
...
- **Модератор (`moderator`)**  
Всё, что доступно пользователю, плюс право удалять **любые** отзывы и комментарии.

- **Администратор (`admin`)**  
Полный контроль:
- управление всем контентом проекта,
- создание и удаление произведений, категорий, жанров,
- назначение ролей другим пользователям.

- **Суперпользователь Django**  
Обладает всеми правами администратора (`admin`).
